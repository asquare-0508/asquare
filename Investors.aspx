<%@ Page Title="Dashbord" AutoEventWireup="true" Language="C#" CodeBehind="Investors.aspx.cs" Inherits="WebApplication1.Investors" %>
    ...
    <div class="row">
        ...
        <div class="card shadow mb-6">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Create Investor</h6>
            </div>

            <div class="card-body">

                <div class="form-group">
                    <asp:DropDownList ID="drpClintId" runat="server" type="text" class="form-control form-control-user"></asp:DropDownList>
                </div>

                <div class="form-group">
                    <asp:DropDownList ID="drpNomineeId" runat="server" type="text" class="form-control form-control-user"></asp:DropDownList>
                </div>

                <div class="form-group">
                    <asp:DropDownList ID="drpRelationship" runat="server" type="text" class="form-control form-control-user"></asp:DropDownList>
                </div>

                <div class="form-group">
                    <asp:TextBox ID="txtJionDate" runat="server" type="text" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Jion date"></asp:TextBox>
                </div>

                <div class="form-group">
                    <asp:TextBox ID="txtMatureDate" runat="server" type="text" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Mature date"></asp:TextBox>
                </div>
